...
export function PlayIcon({ size = 54, className }: IconProps) {
  return (
    <svg
...
export function PauseIcon({ size = 54, className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function HeartIcon({ size = 16, className, fill = "currentColor" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
